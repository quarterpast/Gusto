(function(){
  var Config, Log, async, Q, http, url, querystring, vm, fs, util, Sync, Router, Errors, Loader, Controller, Controllers, SyncPromise, Timer, Server, _ref;
  ...
  _ref = require("../mvc/controller"), Controller = _ref.Controller, Controllers = _ref.Controllers;
  ...
  exports.Server = Server = (function(){
    ...
    function Server(port, host){
      ...
      Sync(function(){
        var controllers;
        return controllers = new Controllers;
      }, __bind(this, 'error'));
      Sync(function(){
