(function(){
  ...
  exports.Server = Server = (function(superclass){
    ...
    var prototype = __extend(Server, superclass).prototype, constructor = Server;
    ...
    function Server(){
      superclass.call(this, __bind(this, 'serve'));
    }
    prototype.listen = function(port, host){
      Log.log("listening on %s:" + port, host || "*");
      return superclass.prototype.listen.apply(this, arguments);
    };
    return Server;
  }(http.Server));
