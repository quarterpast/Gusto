(function(){
  ...
  exports.Router = Router = (function(){
      ...
      for (__i = 0, __len = (__ref = this.routers).length; __i < __len; ++__i) {
        ...
        for (__j = 0, __len1 = (__ref1 = router.routes).length; __j < __len1; ++__j) {
          ...
          if (params = route.match(req)) {
            ...
            __results.push(new exports.NotFound(req.url));
          }
        }
      }
      return __results;
    ...
    prototype.routeHash = {};
    prototype.__defineGetter__('routes', function(){
  ...
  function __fn(id, func){
    var __ref;
    if (typeof id === 'function') {
      __ref = [[], id], id = __ref[0], func = __ref[1];
    }
    if (typeof id === 'string') {
      id = [id];
    }
    if (func.id != null) {
      id = id.concat(func.id);
    }
    return func.id = id, func.method = m.toUpperCase(), func;
  }
}).call(this);
