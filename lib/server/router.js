(function(){
  var Config, signal, url, methods, NotFound, Route, Router, Methods;
  ...
  methods.forEach(function(method){
    return exports[method.toLowerCase()] = function(id, func){
      ...
      if (typeof id === 'string') {
        ...
        return id[method] = true, id;
      }
    };
  });
  exports.any = exports['*'];
  exports.Methods = Methods = (function(){
    Methods.displayName = 'Methods';
    var m, __i, __ref, __len, prototype = Methods.prototype, constructor = Methods;
    for (__i = 0, __len = (__ref = methods).length; __i < __len; ++__i) {
      m = __ref[__i];
      prototype = __fn;
    }
    prototype.alias = function(obj){
      var m, url, __i, __ref, __len, __results = [];
      switch (false) {
      case typeof obj !== 'string':
        for (__i = 0, __len = (__ref = methods).length; __i < __len; ++__i) {
          m = __ref[__i];
          __results.push(this[m].push(obj));
        }
        return __results;
        break;
      default:
        for (m in obj) {
          url = obj[m];
          __results.push(this[m].push(url));
        }
        return __results;
      }
    };
