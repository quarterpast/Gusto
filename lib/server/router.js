(function(){
  var Config, signal, url, flip, methods, NotFound, Aliases, Route, Router;
  ...
  exports.Router = Router = (function(){
    ...
    prototype.add = __curry(function(path, action){
      return console.log(path, action);
    });
    methods.forEach(function(method){
      return prototype[method.toLowerCase()] = flip(__compose((prototype.add),(exports[method])));
    });
    prototype.any = prototype.add(null);
