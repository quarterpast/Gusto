(function(){
  var Config, signal, url, flip, each, objToFunc, methods, everyMethod, NotFound, Aliases, Route, Router, __ref;
  Config = require("../main").Config;
  signal = require("../mvc/signal").signal;
  url = require('url');
  __ref = require('prelude-ls'), flip = __ref.flip, each = __ref.each, objToFunc = __ref.objToFunc;
  ...
  exports.Router = Router = (function(){
    ...
    prototype.add = function(path, action){
      if (action.aliases != null) {
        everyMethod(__compose((console.log),(objToFunc(action.aliases))));
      }
