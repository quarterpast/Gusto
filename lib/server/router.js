(function(){
  ...
  Script = (function(){
    ...
    prototype.runInNewContext = function(){
      ...
      return __bind(this.script, 'runInNewContext').apply(null, args);
    };
    prototype.runInContext = function(){
      var args;
      args = __slice.call(arguments);
      return __bind(this.script, 'runInContext').apply(null, args);
    };
    prototype.runInThisContext = function(){
      var args;
      args = __slice.call(arguments);
      return __bind(this.script, 'runInThisContext').apply(null, args);
    };
    return Script;
  }());
  exports.Errors = {};
  ...
  exports.Router = Router = (function(){
    ...
    function Router(){
      var _this = this;
      fs.readFile(Config.routes, function(err, data){
        var line, parts;
        if (err) {
          throw err;
        }
        return _this.compiled = (function(){
