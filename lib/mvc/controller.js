(function(){
  var util, pathutil, Loader, Config, Log, async, Renderer, Sync, ControllerSupport, __ref, __slice = [].slice;
  util = require('util');
