(function(){
  var util, pathutil, Loader, Config, Log, async, Renderer, Sync, Controllers, Controller, _ref, __split = ''.split;
  util = require('util');
  ...
  Sync = require('sync');
  Controllers = (function(superclass){
    ...
    function Controllers(){
      var _this = this;
      Sync(function(){
        return superclass.call(_this, Config.controllerPath, function(ctrlrs){
