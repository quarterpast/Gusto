(function(){
  var util, pathutil, Loader, Config, Log, async, Renderer, Sync, ControllerSupport, Controller, Controllers, __ref, __split = ''.split, __slice = [].slice;
  util = require('util');
  ...
  exports.Controllers = new (Controllers = (function(superclass){
    ...
    prototype.run = function(){
      return superclass.prototype.run.apply(this, arguments);
    };
    return Controllers;
  }(Loader)));
