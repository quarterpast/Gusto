(function(){
  var Q, crypto, Log, Server, syncPromise, promiseFuture, syncStream, futureStream, __slice = [].slice;
  Q = require('q');
  ...
  exports.syncPromise = exports.async(syncPromise = __curry(function(pr){
  ...
  exports.syncStream = syncStream = (function(){
    ...
    function syncStream(read, length){
      ...
      __this.read.on('data', function(chunk){
        var bigger;
        if (chunk.length > __this.$buffer.length - offset) {
